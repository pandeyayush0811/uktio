...
async function transcribeAudio(audioBuffer, mimeType) {
  ...
  // NOTE: no 'language' param on purpose. Forcing 'en' here doesn't just
  // "hint" the model — it forces it to decode the audio AS English
  // phonemes, so Hindi/Hinglish speech comes out as garbled or wrong
  // English text instead of being transcribed correctly. Omitting it lets
  // Whisper auto-detect (Hindi, English, or code-switched Hinglish).
